...
export const generateAFKProofs = async (
  ...
  return {
    ...
    claimCommitments_1: publicSignals[1],
    claimCommitments_2: publicSignals[2],
    claimCommitments_3: publicSignals[3],
    claimCommitments_4: publicSignals[4],
    claimCommitments_5: publicSignals[5],
    claimKeys_1: publicSignals[6],
