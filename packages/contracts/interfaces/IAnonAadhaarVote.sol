...
interface IAnonAadhaarVote {
    ...
    function voteForProposal(uint256 proposalIndex, uint256[2] calldata _pA, uint[2][2] calldata _pB, uint[2] calldata _pC, uint[5] calldata _pubInputs, uint256 signal) external;
